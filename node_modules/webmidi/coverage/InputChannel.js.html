...
<head>
    <title>Code coverage report for InputChannel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> InputChannel.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">5.36% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>3/56</span>
            </div>
...
<a name='L573'></a><a href='#L573'>573</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
   ...
   * @protected
   */
<span class="fstat-no" title="function not covered" >  _parseEvent(e</span>) {
&nbsp;
    // Extract data bytes (unless it's a sysex message)
    let dataBytes = <span class="cstat-no" title="statement not covered" >null;</span>
    if (<span class="cstat-no" title="statement not covered" >e.data[0] !== WebMidi.MIDI_SYSTEM_MESSAGES.sysex) dataBytes = e.data.slice(1);</span>
&nbsp;
    /**
    ...
    let midiMessageEvent = <span class="cstat-no" title="statement not covered" >{</span>
      ...
      type: <span class="cstat-no" title="statement not covered" >"midimessage"</span>
    };
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  _parseEventForStandardMessages(e</span>) {
&nbsp;
    let command = <span class="cstat-no" title="statement not covered" >e.data[0] &gt;&gt; 4;</span>
    let data1, data2;
&nbsp;
    if (<span class="cstat-no" title="statement not covered" >e.data.length &gt; 1) {</span>
      data1 = e.data[1];
...
&nbsp;
    if (
<span class="cstat-no" title="statement not covered" >      command === WebMidi.MIDI_CHANNEL_VOICE_MESSAGES.noteoff ||</span>
...
&nbsp;
   ...
   * @since 2.0.0
   */
<span class="fstat-no" title="function not covered" >  getChannelModeByNumber(<span class="cstat-no" title="statement not covered" >n</span>umber) {</span>
&nbsp;
    number = Math.floor(number);
&nbsp;
    if ( !(number &gt;= 120 &amp;&amp; status &lt;= 127) ) <span class="cstat-no" title="statement not covered" >return <span class="cstat-no" title="statement not covered" >false;</span></span>
&nbsp;
    for (let cm in WebMidi.<span class="cstat-no" title="statement not covered" >MIDI_CHANNEL_MODE_MESSAGES) {</span>
&nbsp;
      if (
        WebMidi.MIDI_CHANNEL_MODE_MESSAGES.hasOwnProperty(cm) &amp;&amp;
        number === WebMidi.MIDI_CHANNEL_MODE_MESSAGES[<span class="cstat-no" title="statement not covered" >cm]</span>
      ) {
        return cm;
      }
&nbsp;
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  _parseEventForNrpnMessage(<span class="cstat-no" title="statement not covered" >e</span>) {</span>
&nbsp;
    if (!this.nrpnEventsEnabled) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    // Extract basic data
    let command = <span class="cstat-no" title="statement not covered" >e.data[0] &gt;&gt; 4;</span>
    let channel = (e.data[<span class="cstat-no" title="statement not covered" >0] &amp; 0xf) + <span class="cstat-no" title="statement not covered" >1;</span></span>
    let data1;
    let data2;
&nbsp;
    if (e.data.length &gt; 1) {
    ...
    if (
      !(
        ...
        (
          ...
          data1 === WebMidi.MIDI_NRPN_MESSAGES.<span class="cstat-no" title="statement not covered" >entrylsb</span>
        )
      )
    ) {
      return;
...
&nbsp;
    ...
    let ccEvent = <span class="cstat-no" title="statement not covered" >{</span>
      ...
      value: <span class="cstat-no" title="statement not covered" >data2</span>
    };
&nbsp;
    if (
      ...
      ccEvent.value != WebMidi.MIDI_NRPN_MESSAGES.<span class="cstat-no" title="statement not covered" >nullactiveparameter</span>
    ) {
      this._nrpnBuffer = [];
      ...
      ccEvent.controller.number === WebMidi.MIDI_NRPN_MESSAGES.<span class="cstat-no" title="statement not covered" >paramlsb</span>
    ) {
...
&nbsp;
      ...
      this._nrpnBuffer.push(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >ccEvent);</span></span>
    } else <span class="cstat-no" title="statement not covered" >if(</span>
      ...
      ccEvent.controller.number === WebMidi.MIDI_NRPN_MESSAGES.<span class="cstat-no" title="statement not covered" >entrylsb</span>
    ) {
      this._nrpnBuffer.push(ccEvent);
&nbsp;
    } else <span class="cstat-no" title="statement not covered" >if(</span>
...
&nbsp;
      let rawData = <span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >[];</span></span>
&nbsp;
      this._nrpnBuffer.forEach(<span class="fstat-no" title="function not covered" >ev =&gt; <span class="cstat-no" title="statement not covered" >r</span>awData.push(ev.data));</span>
&nbsp;
      ...
      if (this._nrpnBuffer.length === <span class="cstat-no" title="statement not covered" >6) {</span>
        nrpnValue = (this._nrpnBuffer[2].value&lt;&lt;7) | (this._nrpnBuffer[3].value);
      }
&nbsp;
      let nrpnControllerType = <span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >"";</span></span>
&nbsp;
      switch (this._nrpnBuffer[2].controller.number) {
      case WebMidi.MIDI_NRPN_MESSAGES.entrymsb:
<span class="cstat-no" title="statement not covered" >        nrpnControllerType = InputChannel.NRPN_TYPES[<span class="cstat-no" title="statement not covered" >0];</span></span>
        break;
      case WebMidi.MIDI_NRPN_MESSAGES.increment:
<span class="cstat-no" title="statement not covered" >        nrpnControllerType = InputChannel.NRPN_TYPES[<span class="cstat-no" title="statement not covered" >1];</span></span>
        break;
      case WebMidi.MIDI_NRPN_MESSAGES.decrement:
<span class="cstat-no" title="statement not covered" >        nrpnControllerType = InputChannel.NRPN_TYPES[<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >2];</span></span></span>
        break;
      default:
        throw new Error(<span class="cstat-no" title="statement not covered" >"The NPRN type was unidentifiable.");</span>
      }
&nbsp;
...
&nbsp;
      ...
      let nrpnEvent = <span class="cstat-no" title="statement not covered" >{</span>
        ...
        rawValue: <span class="cstat-no" title="statement not covered" >nrpnValue</span>
      };
&nbsp;
      this.emit(nrpnEvent.type, <span class="cstat-no" title="statement not covered" >nrpnEvent);</span>
&nbsp;
    } else {
      // something didn't match, clear the incomplete NRPN message buffer
      this._nrpnBuffer = <span class="cstat-no" title="statement not covered" >[];</span>
    }
  }
&nbsp;
  /**
  ...
  set nrpnEventsEnabled(enabled) {
    this._nrpnEventsEnabled = !!<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >enabled;</span></span>
  }
&nbsp;
  /**
