...
<head>
    <title>Code coverage report for Output.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> Output.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">93.41% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>85/91</span>
            </div>
...
<a name='L1849'></a><a href='#L1849'>1849</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1286x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  constructor(<span class="missing-if-branch" title="if path not taken" >I</span>midiOutput) {
&nbsp;
    super();
&nbsp;
    if (!midiOutput || midiOutput.<span class="cstat-no" title="statement not covered" >type !== "output") {</span>
...
&nbsp;
    } else if (e.port.connection === <span class="branch-1 cbranch-no" title="branch not covered" >"closed" &amp;&amp; e.port.state === "disconnected") {</span>
&nbsp;
      /**
...
<span class="branch-1 cbranch-no" title="branch not covered" >      console.warn("The 'clear()' method has not yet been implemented in your environment.");</span>
    }
    return this;
  }
&nbsp;
...
&nbsp;
   ...
   * @since 3.0.0
   */
  setSong(value, options = <span class="missing-if-branch" title="if path not taken" >I</span>{}) {
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >      console.warn("The 'rawVelocity' option is deprecated. Use 'rawAttack' instead.");</span>
    }
    if (options.velocity) {
<span class="branch-1 cbranch-no" title="branch not covered" >      console.warn("The 'velocity' option is deprecated. Use 'velocity' instead.");</span>
    }
&nbsp;
    WebMidi.sanitizeChannels(channel).forEach(ch =&gt; {
...
&nbsp;
   ...
   */
  get connection() {
    return this._midiOutput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >connection;</span></span>
  }
&nbsp;
  /**
   ...
   */
  get manufacturer() {
    return this._midiOutput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >manufacturer;</span></span>
  }
&nbsp;
  /**
   ...
   */
  get state() {
    return this._midiOutput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >state;</span></span>
  }
&nbsp;
  /**
