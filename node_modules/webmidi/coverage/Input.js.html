...
<head>
    <title>Code coverage report for Input.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> Input.js</h1>
        <div class='clearfix'>
...
<a name='L850'></a><a href='#L850'>850</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    } else if (e.port.connection === <span class="branch-1 cbranch-no" title="branch not covered" >"closed" &amp;&amp; e.port.state === "connected") {</span>
&nbsp;
      /**
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  _onMidiMessage(e</span>) {
&nbsp;
...
&nbsp;
    ...
    } else if (<span class="cstat-no" title="statement not covered" >e.data[0] &lt;= 255) {  // system message</span>
      this._parseEvent(e);
    }
&nbsp;
  }
...
&nbsp;
    let command = <span class="cstat-no" title="statement not covered" >e.data[0];</span>
&nbsp;
    // Returned event
...
&nbsp;
    if (<span class="cstat-no" title="statement not covered" >command === WebMidi.MIDI_SYSTEM_MESSAGES.sysex) {</span>
&nbsp;
      /**
...
&nbsp;
    ...
    if (this._midiInput) {
      ...
      return <span class="branch-1 cbranch-no" title="branch not covered" >Promise.resolve();</span>
    }
&nbsp;
  }
&nbsp;
   ...
   * @since 2.0.0
   */
<span class="fstat-no" title="function not covered" >  getCcNameByNumber(<span class="cstat-no" title="statement not covered" >n</span>umber) {</span>
&nbsp;
    number = Math.floor(number);
&nbsp;
    if ( !(number &gt;= 0 &amp;&amp; number &lt;= 119) ) <span class="cstat-no" title="statement not covered" >return <span class="cstat-no" title="statement not covered" >false;</span></span>
&nbsp;
    for (let cc in WebMidi.<span class="cstat-no" title="statement not covered" >MIDI_CONTROL_CHANGE_MESSAGES) {</span>
&nbsp;
      if (
        WebMidi.MIDI_CONTROL_CHANGE_MESSAGES.hasOwnProperty(cc) &amp;&amp;
        number === WebMidi.MIDI_CONTROL_CHANGE_MESSAGES[<span class="cstat-no" title="statement not covered" >cc]</span>
      ) {
        return <span class="cstat-no" title="statement not covered" >cc;</span>
      }
&nbsp;
    }
&nbsp;
...
&nbsp;
   ...
   * @since 3.0.0
   */
<span class="fstat-no" title="function not covered" >  addOneTimeListener(t</span>ype, channel, listener, options = <span class="cstat-no" title="statement not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span></span>
    options.remaining = 1;
...
&nbsp;
   ...
   * @private
   */
<span class="fstat-no" title="function not covered" >  on(t</span>ype, channel, listener, <span class="cstat-no" title="statement not covered" >options) {</span>
    return this.addListener(type, channel, listener, options);
  }
&nbsp;
  /**
...
&nbsp;
      return <span class="branch-0 cbranch-no" title="branch not covered" >WebMidi.sanitizeChannels(channel).every(<span class="fstat-no" title="function not covered" >ch =&gt; {</span></span>
        return <span class="cstat-no" title="statement not covered" >this.channels[ch].hasListener(type, listener);</span>
      });
&nbsp;
    } else {
...
&nbsp;
   ...
   * @throws {TypeError} The "listener" parameter must be a function..
   */
  removeListener(type, channel, listener, <span class="missing-if-branch" title="if path not taken" >I</span>options) {
&nbsp;
    if (WebMidi.MIDI_CHANNEL_VOICE_MESSAGES[type] !== undefined) {
<span class="cstat-no" title="statement not covered" >      WebMidi.sanitizeChannels(channel).forEach(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >ch =&gt; {</span></span></span>
        this.channels[ch].removeListener(type, listener, options);
      });
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (<span class="cstat-no" title="statement not covered" >type != undefined) {</span>
      return super.removeListener(type, listener, options);
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (type == undefined) {
...
&nbsp;
   ...
   */
  get id() {
    return this._midiInput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >id;</span></span>
  }
&nbsp;
  /**
   ...
   */
  get connection() {
    return this._midiInput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >connection;</span></span>
  }
&nbsp;
  /**
   ...
   */
  get manufacturer() {
    return this._midiInput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >manufacturer;</span></span>
  }
&nbsp;
  /**
   ...
   */
  get state() {
    return this._midiInput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >state;</span></span>
  }
&nbsp;
  /**
   ...
   */
  get type() {
    return this._midiInput.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >type;</span></span>
  }
&nbsp;
  /**
   * @type {boolean}
