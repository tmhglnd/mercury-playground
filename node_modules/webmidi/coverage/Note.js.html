...
<head>
    <title>Code coverage report for Note.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> Note.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {WebMidi} from "./WebMidi.js";
&nbsp;
/**
...
&nbsp;
    ...
    if (options.rawRelease) this.rawRelease = options.<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >rawRelease;</span></span>
&nbsp;
  }
&nbsp;
  /**
...
&nbsp;
  ...
  set rawAttack(value) {
    ...
    this._rawAttack = isNaN(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >64 : v</span>alue;
  }
&nbsp;
  /**
...
&nbsp;
  ...
  set rawRelease(value) {
    value = Math.min(Math.max(parseInt(value), 0), 127);
    this._rawRelease = isNaN(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >64 : v</span>alue;
  }
&nbsp;
  /**
