...
<head>
    <title>Code coverage report for OutputChannel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> OutputChannel.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>95/168</span>
            </div>
...
<a name='L1387'></a><a href='#L1387'>1387</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7696x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7698x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {EventEmitter} from "../node_modules/djipevents/dist/djipevents.esm.min.js";
...
&nbsp;
   ...
   */
  send(status, data = <span class="branch-0 cbranch-no" title="branch not covered" >[], t</span>imestamp) {
...
&nbsp;
   ...
   */
  setKeyAftertouch(note, pressure, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    // Validation
    pressure = parseFloat(pressure);
    if (isNaN(pressure)) <span class="branch-1 cbranch-no" title="branch not covered" >pressure = 0.5;</span>
    if (options.useRawValue) <span class="branch-1 cbranch-no" title="branch not covered" >pressure = pressure / 127;</span>
    if (pressure &lt; 0 || pressure &gt; <span class="cstat-no" title="statement not covered" >1) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  sendControlChange(controller, value, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    if (typeof <span class="cstat-no" title="statement not covered" >controller === "string") {</span>
&nbsp;
      controller = WebMidi.MIDI_CONTROL_CHANGE_MESSAGES[controller];
      if (controller === undefined) <span class="cstat-no" title="statement not covered" >throw new TypeError(<span class="missing-if-branch" title="if path not taken" >I</span>"Invalid controller name.");</span>
&nbsp;
    } else {
&nbsp;
      controller = Math.floor(controller);
      if (!(controller &gt;= 0 &amp;&amp; controller &lt;= <span class="cstat-no" title="statement not covered" >119)) {</span>
...
&nbsp;
   ...
   * in the past, the operation will be carried out as soon as possible.
   */
  _selectNonRegisteredParameter(parameter, <span class="missing-if-branch" title="if path not taken" >I</span>time) {
&nbsp;
    parameter[0] = Math.floor(parameter[0]);
    if (!(parameter[0] &gt;= 0 &amp;&amp; parameter[0] &lt;= <span class="cstat-no" title="statement not covered" >127)) {</span>
      throw new RangeError(<span class="missing-if-branch" title="if path not taken" >I</span>"The control63 value must be between 0 and 127.");
    }
&nbsp;
    parameter[1] = Math.floor(parameter[1]);
    if (!(parameter[1] &gt;= 0 &amp;&amp; parameter[1] &lt;= <span class="cstat-no" title="statement not covered" >127)) {</span>
...
&nbsp;
   ...
   * in the past, the operation will be carried out as soon as possible.
   */
  _setCurrentRegisteredParameter(data, <span class="missing-if-branch" title="if path not taken" >I</span>time) {
&nbsp;
    data = [].concat(data);
&nbsp;
    // MSB
    data[0] = parseInt(data[0]);
    if (!isNaN(data[0]) &amp;&amp; data[0] &gt;= 0 &amp;&amp; data[0] &lt;= <span class="cstat-no" title="statement not covered" >127) {</span>
      this.sendControlChange(0x06, data[0], {time: time});
    } else {
      throw new RangeError("The msb value must be between 0 and 127.");
    }
&nbsp;
    if (data.length &lt; 2) return <span class="missing-if-branch" title="if path not taken" >I</span>this;
&nbsp;
    // LSB
    data[1] = parseInt(data[1]);
&nbsp;
    if (!isNaN(data[1]) &amp;&amp; data[1] &gt;= 0 &amp;&amp; data[1] &lt;= <span class="cstat-no" title="statement not covered" >127) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  playNote(note, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    // Send note on message and, optionally, note off message
    this.sendNoteOn(note, options);
    if (!isNaN(options.duration)) <span class="branch-1 cbranch-no" title="branch not covered" >this.sendNoteOff(note, options);</span>
&nbsp;
    return this;
&nbsp;
  }
...
<span class="branch-1 cbranch-no" title="branch not covered" >      options.rawRelease = options.velocity;</span>
      console.warn(
        "The 'rawVelocity' option is deprecated. Use 'rawRelease' instead."
      );
    }
    if (options.velocity) {
<span class="branch-1 cbranch-no" title="branch not covered" >      options.release = options.velocity;</span>
...
&nbsp;
    if (options.<span class="branch-0 cbranch-no" title="branch not covered" >rawRelease) {</span>
      if (
...
<span class="branch-1 cbranch-no" title="branch not covered" >        options.release &gt;= 0 &amp;&amp;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >        options.release &lt;= 1</span>
      ) {
<span class="branch-3 cbranch-no" title="branch not covered" >        nVelocity = options.release * 1</span>27;
      }
    }
&nbsp;
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  sendNoteOn(note, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    // Compatibility warnings
    if (options.rawVelocity) {
<span class="branch-1 cbranch-no" title="branch not covered" >      options.rawAttack = options.velocity;</span>
    ...
    if (options.velocity) {
<span class="branch-1 cbranch-no" title="branch not covered" >      options.attack = options.velocity;</span>
      console.warn("The 'velocity' option is deprecated. Use 'attack' instead.");
    }
&nbsp;
    let nVelocity = 64;
&nbsp;
    if (options.<span class="branch-0 cbranch-no" title="branch not covered" >rawAttack) {</span>
      if (
      ...
      if (
        !isNaN(options.attack) &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >        options.attack &gt;= 0 &amp;&amp;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >        options.attack &lt;= 1</span>
      ) {
<span class="branch-3 cbranch-no" title="branch not covered" >        nVelocity = options.attack * 1</span>27;
      }
    }
&nbsp;
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  sendChannelMode(command, value, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    if (typeof command === "string") {
      command = WebMidi.MIDI_CHANNEL_MODE_MESSAGES[command];
    } else {
      command = <span class="branch-1 cbranch-no" title="branch not covered" >parseInt(command);</span>
    }
&nbsp;
    if (isNaN(command) || !(command &gt;= 120 &amp;&amp; command &lt;= <span class="cstat-no" title="statement not covered" >127)) {</span>
      throw new TypeError(<span class="missing-if-branch" title="if path not taken" >I</span>"Invalid channel mode message name or number.");
    }
&nbsp;
    value = parseInt(value) || 0;
&nbsp;
    if (value &lt; 0 || value &gt; <span class="cstat-no" title="statement not covered" >127) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setOmniMode(state, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    if (state === undefined || state) {
      this.sendChannelMode("omnimodeon", 0, <span class="branch-1 cbranch-no" title="branch not covered" >options);</span>
    } else {
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setChannelAftertouch(pressure, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    // Validation
    pressure = parseFloat(pressure);
    if (isNaN(pressure)) <span class="branch-1 cbranch-no" title="branch not covered" >pressure = 0.5;</span>
    if (options.rawValue) <span class="branch-1 cbranch-no" title="branch not covered" >pressure = pressure / 127;</span>
    if (pressure &lt; 0 || pressure &gt; <span class="cstat-no" title="statement not covered" >1) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setMasterTuning(value, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    value = parseFloat(value) || <span class="branch-1 cbranch-no" title="branch not covered" >0.0;</span>
&nbsp;
    if (value &lt;= -65 || value &gt;= <span class="cstat-no" title="statement not covered" >64) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setModulationRange(semitones, cents, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setNonRegisteredParameter(parameter, data, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    data = [].concat(data);
&nbsp;
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setPitchBend(value, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    // Validation
    value = parseFloat(value);
    if (isNaN(value)) <span class="branch-1 cbranch-no" title="branch not covered" >value = 0;</span>
    if (options.rawValue) <span class="branch-1 cbranch-no" title="branch not covered" >value = value / 127 * 2 - 1;</span>
    if (value &lt; -1 || value &gt; <span class="cstat-no" title="statement not covered" >1) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setPitchBendRange(semitones, cents, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    this.setRegisteredParameter(
...
&nbsp;
   ...
   *
   */
  setProgram(program, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setRegisteredParameter(parameter, data, options = <span class="missing-if-branch" title="else path not taken" >E</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    if (!Array.isArray(parameter)) <span class="missing-if-branch" title="if path not taken" >I</span>{
      if (!WebMidi.MIDI_REGISTERED_PARAMETER[<span class="cstat-no" title="statement not covered" >parameter]) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setTuningBank(value, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    value = parseInt(value);
    if (isNaN(value) || !(value &gt;= 1 &amp;&amp; value &lt;= <span class="cstat-no" title="statement not covered" >128)) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setTuningProgram(value, options = <span class="missing-if-branch" title="if path not taken" >I</span><span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
&nbsp;
    value = parseInt(value);
    if (isNaN(value) || !(value &gt;= 1 &amp;&amp; value &lt;= <span class="cstat-no" title="statement not covered" >128)) {</span>
      throw new RangeError("The program value must be between 1 and 128.");
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setLocalControl(state, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
    if (state) {
      return this.sendChannelMode("localcontrol", 127, options);
    } else {
      return <span class="branch-1 cbranch-no" title="branch not covered" >this.sendChannelMode("localcontrol", 0, options);</span>
    }
  }
&nbsp;
  /**
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  turnNotesOff(options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  turnSoundOff(options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  resetAllControllers(options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
...
&nbsp;
   ...
   * @returns {OutputChannel} Returns the `OutputChannel` object so methods can be chained.
   */
  setPolyphonicMode(mode, options = <span class="branch-0 cbranch-no" title="branch not covered" >{}) {</span>
    if (mode === "mono") {
      return this.sendChannelMode("monomodeon", 0, options);
    } else {
      return <span class="branch-1 cbranch-no" title="branch not covered" >this.sendChannelMode("polymodeon", 0, options);</span>
    }
  }
&nbsp;
}
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat May 09 2020 20:20:04 GMT-0400 (Eastern Daylight Time)
            </div>
        </div>
