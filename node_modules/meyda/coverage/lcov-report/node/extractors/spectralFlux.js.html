...
<html lang="en">
<head>
    <title>Code coverage report for node/extractors/spectralFlux.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">node/extractors/</a> spectralFlux.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
exports.default = <span class="fstat-no" title="function not covered" >function (args) {</span>
<span class="cstat-no" title="statement not covered" >  if (_typeof(args.signal) !== 'object' || _typeof(args.previousSignal) != 'object') {</span>
<span class="cstat-no" title="statement not covered" >    throw new TypeError();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var sf = 0;</span>
<span class="cstat-no" title="statement not covered" >  for (var i = -(args.bufferSize / 2); i &lt; signal.length / 2 - 1; i++) {</span>
<span class="cstat-no" title="statement not covered" >    x = Math.abs(args.signal[i]) - Math.abs(args.previousSignal[i]);</span>
<span class="cstat-no" title="statement not covered" >    sf += (x + Math.abs(x)) / 2;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return sf;</span>
};
&nbsp;
