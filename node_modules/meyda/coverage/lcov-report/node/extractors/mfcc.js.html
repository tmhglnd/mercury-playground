...
<html lang="en">
<head>
    <title>Code coverage report for node/extractors/mfcc.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">node/extractors/</a> mfcc.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">92×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23552×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23552×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
exports.default = function (args) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_typeof(args.melFilterBank) !== 'object') {
<span class="cstat-no" title="statement not covered" >    throw new TypeError('Valid melFilterBank is required to generate MFCC');</span>
  }
&nbsp;
...
&nbsp;
  ...
  //   }
  // }
  var numberOfMFCCCoefficients = Math.min(40, Math.max(1, args.numberOfMFCCCoefficients || 13));
&nbsp;
  // Tutorial from:
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (numFilters &lt; numberOfMFCCCoefficients) {
<span class="cstat-no" title="statement not covered" >    throw new Error("Insufficient filter bank for requested number of coefficients");</span>
  }
&nbsp;
