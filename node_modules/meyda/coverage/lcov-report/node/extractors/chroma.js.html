...
<html lang="en">
<head>
    <title>Code coverage report for node/extractors/chroma.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">node/extractors/</a> chroma.js
    </h1>
    <div class='clearfix'>
...
exports.default = function (args) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_typeof(args.chromaFilterBank) !== 'object') {
<span class="cstat-no" title="statement not covered" >    throw new TypeError('Valid chromaFilterBank is required to generate chroma');</span>
  }
&nbsp;
...
&nbsp;
  return maxVal ? chromagram.map(function (v) {
    return v / maxVal;
  }) : <span class="branch-1 cbranch-no" title="branch not covered" >chromagram;</span>
};
&nbsp;
